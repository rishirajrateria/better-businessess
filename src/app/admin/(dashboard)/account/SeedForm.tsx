...
export function SeedForm() {
  ...
  return (
    <form action={action} className="space-y-3">
      <p className="text-[14px] text-graphite">Adds sample testimonials, client logos, four case studies, three blog articles and two FAQs so the site looks complete on day one. Only fills tables that are empty; edit or delete everything afterwards from the admin.</p>
      <Notice state={state} />
